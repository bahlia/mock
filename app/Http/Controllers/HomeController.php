...
class HomeController extends Controller
{
    ...
    public function categoriaMach(Request $request)
    {
        ...
        $filteredCompanies = array_filter($company, function ($item) use ($categoria) {
            return in_array($categoria, $item['categories']);
        });
            
        return view ('match', $filteredCompanies );
